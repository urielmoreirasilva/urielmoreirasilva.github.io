...
[<img src="https://raw.githubusercontent.com/flaviovdf/fcd/master/assets/colab_favicon_small.png" style="float: right;">](https://colab.research.google.com/github/flaviovdf/fcd/blob/master/_lessons/01-Expressoes.ipynb)
...
> [COMENTAR SOBRE O R AQUI] [*] (why R?)

### Notebooks Jupyter 📓

- Frequentemente, o código é escrito em um editor de texto e depois executado em uma interface de linha de comando.

<center>
<img src='images/terminal.png' width=800>
</center>

- Por ser uma _linguagem interpretada_, o Python nos permite [*]
- IDEs
- Jupyter
...
- Inseriremos nossas expressões em **células de código**.
...
```python
# Note que a célula abaixo mostra apenas um valor. Você sabe porque isso acontece?
3 * 4
5
```
...
Nosso caderno **ainda** se lembra de todas as variáveis ​​que definimos anteriormente.
